...
/**
 * ProcwatcherIMVPolicyManager.
 *
 * Class for querying ProcwatcherIMV specific entries in the policy file.
 *
 * <h3>Changelog:</h3>
 * <ul>
 *   <li>08.03.2010 - create class skeleton (ib)</li>
 *   <li>09.03.2010 - functionally complete (ib)</li>
 *   <li>24.03.2010 - renamed to ProcwatcherIMVPolicyManager (awe)</li>
 * </ul>
 *
 * @date 08.03.2010
 ...
 *
 */
#ifndef PROCWATCHERIMVPOLICYMANAGER_H_
#define PROCWATCHERIMVPOLICYMANAGER_H_
...
class FileEntry {
    public:
        ...
        FileEntry(char * a,char * b);
        FileEntry(const FileEntry &b);
        FileEntry();
        ~FileEntry();
};
...
class ProcwatcherIMVPolicyManager
{
public:
	 ...
	 * Ctor.
	 */
	ProcwatcherIMVPolicyManager(const char *policyFile = "/usr/tnc/procwatcherimv.policy");
	...
	/**
	 * Parses the policy file of the ProcwatcherIMV.
	 */
    ...
    std::vector<FileEntry> getFileEntries();
private:
	/**
	...
	void parsePolicyLineFile(std::string &line);
...
#endif // PROCWATCHERIMVPOLICYMANAGER_H_
