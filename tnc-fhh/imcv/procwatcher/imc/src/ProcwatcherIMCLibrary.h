...
#ifndef PROCWATCHERLIBRARY_H_
#define PROCWATCHERLIBRARY_H_
 ...
 */
class ProcwatcherIMCLibrary : public tncfhh::iml::IMCLibrary{
public:
	/**
	...
	/**
	 * Returns a pointer to a instance of ProcwatcherIMC.
	 */
	 ...
	 * Dtor.
	 */
	virtual ~ProcwatcherIMCLibrary();
};

#endif /* PROCWATCHERIMCLIBRARY_H_ */
